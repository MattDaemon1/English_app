...
function App() {
    ...
    const checkAnswer = () => {
        ...
        setFeedback(isCorrect ? 'Correct ! 🎉' : `Incorrect. La bonne réponse est : ${currentWord.word}`)
                            ...
                            <CardContent className="p-6">
                                {!currentQuiz ? (
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        {feedback && (
                                            <div className={`p-3 rounded-lg ${feedback.includes('Correct')
                            ...
                            <CardContent className="p-6">
                                <div className="space-y-4">
                                    ...
                                    {conversationScenario.steps.map((step, index) => (
                                        <div
                                            key={index}
                                            className={`p-4 rounded-lg transition-all ${step.speaker === 'waiter' || step.speaker === 'salesperson'
                                                    ? 'bg-blue-100 ml-8'
                                                    : 'bg-gray-100 mr-8'
