...
/**
 * Fonction utilitaire pour obtenir les classes CSS d'un thème
 */
export const getThemeClasses = (themeName = 'classic') => {
    const theme = themes[themeName] || themes.classic;
    return theme;
};

/**
 * Hook simple pour utiliser les thèmes
 */
export const useTheme = (themeName = 'classic') => {
